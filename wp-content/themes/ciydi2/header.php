...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        ...
        <header class="<?php echo esc_attr( $mythemes_header_class ); ?>">
            ...
            <nav>
                <div class="orange-ciydi nav-wrapper">
                    ...
                    <?php
                        ...
                        if ( function_exists( 'the_custom_logo' ) && $has_custom_logo = has_custom_logo() ) {
                            echo '<a class="mythemes-blog-logo" style=" margin-top: ' . absint( get_theme_mod( 'mythemes-blog-logo-m-top' ) ) . 'px; margin-bottom: ' . absint( get_theme_mod( 'mythemes-blog-logo-m-bottom' ) ) . 'px;">';
                            the_custom_logo();
                            echo '</a>';
                        ...
                        {   // not collapsed header menu
                             ...
                             */
                                ...
                                if( !empty( $pages ) ){
                                    ...
                                    echo '<a class="menu-item ">  Empresas  </a>';
                        ...
                        {   /**
                             ...
                             */
                                ...
                                if( !empty( $pages ) ){
                                    ...
                                    echo '<a class="menu-item ">  Acceder  </a>';
                                    echo '<a class="menut-item ">  Registrarse  </a>';
